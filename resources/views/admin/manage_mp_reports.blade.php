          ...
          <li class="nav-item">
           ...
           Missing Person
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/manage_mp_reports" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Missing Persons</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage MP Reports</a></li>
