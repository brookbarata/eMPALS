            ...
            <div class="container py-3">
                ...
                <div class="col">
                    ...
                    <ol class="breadcrumb mb-0 px-2">
                        ...
                        <li class="breadcrumb-item"><a href="/police_volunteer/list-of-missing-person">List of Missing Persons</a></li>
                ...
                <div class="col-lg-8">
                    ...
                    <p class="text-muted mb-0">{{$profile->fname}} {{$profile->mname}}</p>
                        ...
                        <div class="row">
                        <div class="col-sm-3">
                            <p class="mb-0">Missing Since</p>
                        </div>
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{$profile->info_missing_date->date}}</p>
                        </div>
                        </div>
                        <hr>
                        <div class="row">
