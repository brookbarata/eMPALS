...
@section('content')
   ...
   <h5 class="text-center bg-dark rounded p-2 text-white">Are you Trying to "Locate Found" the <span class="fw-bold text-danger">Missing</span> Persons Below?</h5>
    <hr> 
                  ...
                  ?>
                    ...
                    <div class="row text-center">
                        ...
                        @if($i == $colcount)
                            ...
                            <div class="btn-group">
                            <a href="{{ route('list-of-missing-person.show', $item)  }}"><button class="py-0 px-1 btn btn-sm btn-primary">View</button></a>
                            <a href="{{ route('respond-missing.show', $item)  }}"><button class="mx-1 py-0 px-1 btn btn-sm btn-outline-secondary">Respond</button></a>
                            </div>
                        @else
                ...
                <a href="/police_volunteer/report-with-suggestion-found"><button class="btn btn-danger btn-lg mx-5">No, Let Me Continue My Reporting...</button> </a>
                </div>
