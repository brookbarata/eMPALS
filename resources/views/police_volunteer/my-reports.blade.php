  ...
  <table class="table">
    ...
    @foreach ($missing_report as $item )      
      <tr>
       ...
       <td> <a href="/police_volunteer/meet_person"> <button class="btn btn-outline-success btn-sm rounded-1" type="button" >I got him/her!</button></a></td>
     </tr>
      <?php
        $i++;
     ?>
   ...
   <table class="table">
    ...
    @foreach ($found_report as $item )      
      <tr>
       ...
       <td> <a href="/police_volunteer/meet_person"> <button class="btn btn-outline-success btn-sm rounded-1" type="button" >Family got him/her!</button></a></td>
     </tr>
      <?php
        $i++;
     ?>
