...
@section('content')
    ...
    <hr> 
     ...
     <div class="row">
       ...
       <div class="col-sm-3 mt-5 card"> <a href="/user/list-of-missing-person" style="text-decoration:none;">
      ...
      <div class="col-sm-3 mt-5 card"> <a href="/user/list-of-found-person" style="text-decoration:none;">
