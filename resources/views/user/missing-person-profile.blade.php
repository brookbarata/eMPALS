            ...
            <div class="container py-3">
                ...
                <div class="col">
                    ...
                    <ol class="breadcrumb mb-0 px-2">
                        ...
                        <li class="breadcrumb-item"><a href="/user/list-of-missing-person">List of Missing Persons</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Missing Person Profile</li>
                    </ol>
                    </nav>
                </div>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('user-respond-missing.show', $profile->id)  }}"> <button type="button" class="btn btn-primary">Respond</button></a>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-sm-3">
                            <p class="mb-0">Age when Missing</p>
                        </div>
                        <div class="col-sm-9">
