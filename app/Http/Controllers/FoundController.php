    ...
    public function index(){
     ...
     public function store(Request $request)
     {
         $validator= Validator::make($request->all(),[
             ...
             if($validator->fails()){
                return redirect('user/report-found')->with('danger', 'Error! Please Enter Some Valid Inputs.');
                ...
                \Session::put('photo','/storage/'.$path);   
                  ...
                  if($data['results']->isNotEmpty()){
                    return view('user/suggestions/suggestions-found', $data)->with('success', 'Reports Frist Part added, go ahead.');
                 }
                else{
                    return view('user/report-with-suggestion-found')->with('error', 'Noops, You does not have any suggestions!');
                }
     }
    }
}
